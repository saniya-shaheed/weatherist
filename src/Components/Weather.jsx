      ...
      if (selectedCity) {
        fetchWeatherDataForCity(selectedCity)
          .then((data) => {
            ...
            return Promise.all([
              fetchWeatherDataForCoordinates(lat, lon),
        ...
        navigator.geolocation.getCurrentPosition(
          (position) => {
            ...
            Promise.all([
              fetchWeatherDataForCoordinates(latitude, longitude),
    ...
    <div className="d-sm-flex pt-3 ps-2 ps-sm-3">
            ...
            <div className="current-weather d-flex pt-xl-5 pb-xl-5">
              <div className=" col-6 ">
                ...
                <p className="display-1">
                  <b> {Math.round(weatherData.main.temp)}&deg;C </b>
                </p>
              </div>
            ...
            <div className=" ">
              <div className="air-conditions bg-light border rounded-3 p-3 ps-2 pb-lg-2 pt-xl-5 pb-xl-5">
                <div className="d-flex">
                  <h6 className="text-secondary me-auto ps-2 pt-2  pb-2">
                    {" "}
                    AIR CONDITIONS{" "}
                  </h6>
                  <div className="pt-2">
              ...
              <div className="pt-3 pb-3">
                <div className="hourly-forcast bg-light border rounded-3 p-3 ps-2 pt-xl-5 pb-xl-5">
                  <h6 className="text-secondary me-auto ps-2 p-3">
                    TODAY'S FORECAST
                  </h6>
                    ...
                    {hourlyForecast.map((hour, index) => {
                      ...
                      return (
                        index < 5 && (
                          <div
                            key={hour.dt}
                            className="hourly-forcast-window w-100 d-flex flex-md-column align-items-md-center"
                          >
                            ...
                            <p className="col-4 d-flex justify-content-center">
                              <img
                                src={`http://openweathermap.org/img/w/${hour.icon}.png`}
                                alt={hour.weather}
                              />
                            </p>
                            <p className="col-4 d-flex justify-content-end justify-content-md-center">
                              <b>
                                {convertKelvinToCelsius(hour.temp).toFixed(0)}
                                &deg;C{" "}
                              </b>
                            </p>
                          </div>
      ...
      <div className="content-right pb-3 col-sm-6 ps-sm-2 pe-sm-2">
        <div className="daily-forecast bg-light border rounded-3 pt-xl-5 pb-xl-5 ">
          <h6 className="text-secondary p-3 pt-4 "> DAILY FORECAST</h6>
          {dailyForecast.length > 0 ? (
            dailyForecast.map((day) => (
              <div className="daily-details d-flex ps-2 pe-2 align-items-center border-bottom">
                <p
                  key={day.dt}
                  className=" text-secondary col-2  d-flex justify-content-start"
                >
                ...
                />
                <p className="col-4 d-flex text-center justify-content-center">
                  <b>{day.weather} </b>
                </p>
                <p className="col-3 d-flex justify-content-end">
                  <b> {convertKelvinToCelsius(day.temp).toFixed(0)}&deg;C </b>
                </p>
              </div>
            ))
          ) : (
